    ...
    <div className="page">
      ...
      <section className="landing-hero" aria-labelledby="claim-help-heading">
        ...
        <div className="landing-hero-actions">
          {/* Promotional-edge pass 2026-09-24 (Arbo, variant 2): the one
              real action on this page carries the offer color. */}
          <Link className="landing-btn landing-btn-offer" to="/directory">
            Find your business
          </Link>
        </div>
      </section>
